...
class GMSRegulatoryGuard:
    ...
    def _build_extractor(self) -> Any:
        ...
        """
        from forgeloop.agents.extraction import EntitySpec, HybridEntityExtractor
    ...
    def _manifold_flags(self, message: str) -> set[str]:
        ...
        if os.environ.get("AGENTLAB_USE_MANIFOLD", "1") == "0":
            return set()
        try:
            from forgeloop.agents.capstone.manifold_evidence import get_default_scorer
    ...
    def _manifold_entity_flags(self, message: str) -> set[str]:
        ...
        if os.environ.get("AGENTLAB_USE_MANIFOLD_ENTITIES", "0") == "0":
            return set()
        try:
            from forgeloop.agents.capstone.manifold_entities import get_default_extractor
