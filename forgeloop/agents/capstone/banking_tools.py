...
from forgeloop.agents.models.draft_response_lm import get_default_lm
...
def _extract_impl(message: str) -> dict[str, Any]:
    ...
    try:
        from forgeloop.agents.models.qwen_extractor import get_default_extractor
...
def _flag_impl(product: str, issue: str, message: str = "",
    ...
    if message.strip() and os.environ.get("AGENTLAB_USE_LLM_FLAG", "1") != "0":
        try:
            from forgeloop.agents.models.qwen_flagger import get_default_flagger
    ...
    from forgeloop.agents.capstone.regulatory_guard import get_default_guard
...
def _draft_impl(
    ...
    if category == "complaint":
        ...
        if text:
            ...
            from forgeloop.agents.capstone.draft_verifier import get_default_verifier
