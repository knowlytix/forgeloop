...
class AgentMessage:
    ...
    Attributes:
        ...
        message_type: Category of the message, such as "delegate" or "response".
        payload: Structured contents of the message.
        parent_id: Id of the message this one replies to, if any.
