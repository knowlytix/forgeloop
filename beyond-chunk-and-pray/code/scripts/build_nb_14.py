...
"""Emit notebooks/14_abstention_and_coverage_a_inline.ipynb via nbformat (CPU only).
...
NB_PATH = os.path.join(
    os.path.dirname(__file__), "..", "notebooks", "14_abstention_and_coverage_a_inline.ipynb"
)
...
md(
    "# Chapter 12 — Honest abstention and coverage\n"
    "\n"
...
md(
    ...
    "error. Compare this trail to a dense-retrieval answer in Chapter 15, which\n"
...
md(
    ...
    "Chapter 15, flagged `verified=False` for a reason). Second, the coverage\n"
...
md(
    ...
    "relevance gate's job, Chapter 11), and a covered section's triples can be\n"
    ...
    "off-topic queries still abstain is Chapter 13."
)
