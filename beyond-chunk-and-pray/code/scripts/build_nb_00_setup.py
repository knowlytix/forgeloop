...
md(
    ...
    "**What you need**\n"
    "\n"
    "- The licensed **`knowlytix`** substrate (distributed separately, not on\n"
    "  PyPI). If it is not importable, set `KNOWLYTIX_SRC` to your checkout\n"
    "  (see the next cell). Without it, the stores cannot be built.\n"
...
code(
    ...
    "        'knowlytix not found. It is licensed and distributed separately. Set '\n"
    "        \"KNOWLYTIX_SRC to your checkout, e.g. os.environ['KNOWLYTIX_SRC']='/path/to/GMS-knowlytix', \"\n"
